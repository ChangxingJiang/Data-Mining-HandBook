...
>询问用户姓名的功能(任意提交形式)
## Week1 : Python语言基础（一）
### [Day03](https://github.com/Changxing97/Python-Data-mining-Tutorial/blob/master/Week-01/Day03/Day03.md) : 基础语言元素
...
* 列表生成式
* 生成器
### [Example-02](https://github.com/Changxing97/Python-Data-mining-Tutorial/blob/master/Week-02/Example-02/案例_全唐诗文本整理.md) : 全唐诗文本格式整理(无对象应用)
